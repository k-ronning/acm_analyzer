...
def plot_population_forecast_vs_model(population_forecast, baseline_fn):
    ...
    line_fc2012, = ax.plot(plot_x, plot_fc2012, label=T(fi="V-e 2012", en="P.f. 2012"), color="C5", linewidth=active_lw)
    ax.plot(plot_x, plot_fc2012_inactive, label=None, color="C5", linewidth=inactive_lw, linestyle="dashed")
    line_fc2015, = ax.plot(plot_x, plot_fc2015, label=T(fi="V-e 2015", en="P.f. 2015"), color="C2", linewidth=active_lw)
    ax.plot(plot_x, plot_fc2015_inactive, label=None, color="C2", linewidth=inactive_lw, linestyle="dashed")
    line_fc2018, = ax.plot(plot_x, plot_fc2018, label=T(fi="V-e 2018", en="P.f. 2018"), color="C4", linewidth=active_lw)
    ax.plot(plot_x, plot_fc2018_inactive, label=None, color="C4", linewidth=inactive_lw, linestyle="dashed")
    line_fc2019, = ax.plot(plot_x, plot_fc2019, label=T(fi="V-e 2019", en="P.f. 2019"), color="C8", linewidth=active_lw)
    ax.plot(plot_x, plot_fc2019_inactive, label=None, color="C8", linewidth=inactive_lw, linestyle="dashed")
    line_fc2021, = ax.plot(plot_x, plot_fc2021, label=T(fi="V-e 2021", en="P.f. 2021"), color="C1", linewidth=active_lw)
...
def main():
    ...
    finland_deaths_and_population_by_month_extended = combine_deaths_by_month(finland_deaths_by_month_since_1945, finland_deaths_and_population_by_month, min_year=1990, max_year=2021)
